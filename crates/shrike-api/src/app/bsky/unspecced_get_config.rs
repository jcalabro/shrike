...
impl UnspeccedGetConfigLiveNowConfig {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("domains")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.domains.len() as u64)?;
...
) -> Result<UnspeccedGetConfigOutput, shrike_xrpc::Error> {
