...
impl EmbedImagesImage {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.alt)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("image")?;
            ...
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                ...
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.alt)?;
                pairs.push(("alt", vbuf));
            }
            {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(
        ...
        Ok(EmbedImagesImage {
            alt: field_alt.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'alt'".into())
            })?,
            image: field_image.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'image'".into())
            })?,
...
impl EmbedImages {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("images")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.images.len() as u64)?;
...
impl EmbedImagesViewImage {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("alt")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.alt)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("thumb")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.thumb)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("fullsize")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.fullsize)?;
            if self.aspect_ratio.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("aspectRatio")?;
                if let Some(ref val) = self.aspect_ratio {
                    val.encode_cbor(buf)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.thumb)?;
                pairs.push(("thumb", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.fullsize)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(EmbedImagesViewImage {
            ...
            thumb: field_thumb.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'thumb'".into())
            })?,
            fullsize: field_fullsize.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'fullsize'".into())
            })?,
            aspect_ratio: field_aspect_ratio,
            extra: std::collections::HashMap::new(),
            extra_cbor,
