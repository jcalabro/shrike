...
impl EmbedExternalExternal {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("title")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.title)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.title)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(EmbedExternalExternal {
            ...
            title: field_title.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'title'".into())
            })?,
...
impl EmbedExternal {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("external")?;
    ...
    pub fn decode_cbor(
        ...
        Ok(EmbedExternal {
            external: field_external.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'external'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
