...
impl NotificationDefsActivitySubscription {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_bool(self.post)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reply")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_bool(self.reply)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_bool(self.post)?;
                pairs.push(("post", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_bool(self.reply)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(NotificationDefsActivitySubscription {
            ...
            reply: field_reply.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'reply'".into())
            })?,
...
impl NotificationDefsChatPreference {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 2u64;
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("push")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_bool(self.push)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("include")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.include)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_bool(self.push)?;
                pairs.push(("push", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.include)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(NotificationDefsChatPreference {
            push: field_push.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'push'".into())
            })?,
            include: field_include.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'include'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl NotificationDefsFilterablePreference {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_bool(self.list)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("push")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_bool(self.push)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("include")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.include)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_bool(self.list)?;
...
impl NotificationDefsPreferences {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("quote")?;
            self.quote.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reply")?;
            self.reply.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("follow")?;
            self.follow.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("repost")?;
            self.repost.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("mention")?;
            self.mention.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("verified")?;
            self.verified.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("unverified")?;
            self.unverified.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("likeViaRepost")?;
            self.like_via_repost.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("subscribedPost")?;
            self.subscribed_post.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("repostViaRepost")?;
            self.repost_via_repost.encode_cbor(buf)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("starterpackJoined")?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(NotificationDefsPreferences {
            chat: field_chat.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'chat'".into())
            })?,
            like: field_like.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'like'".into())
            })?,
            quote: field_quote.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'quote'".into())
            })?,
            reply: field_reply.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'reply'".into())
            })?,
            follow: field_follow.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'follow'".into())
            })?,
            ...
            mention: field_mention.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'mention'".into())
            })?,
            verified: field_verified.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'verified'".into())
            })?,
            unverified: field_unverified.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'unverified'".into())
            })?,
            like_via_repost: field_like_via_repost.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'likeViaRepost'".into())
            })?,
