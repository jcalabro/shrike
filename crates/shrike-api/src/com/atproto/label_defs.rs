...
pub struct LabelDefsLabel {
    ...
    pub cts: shrike_syntax::Datetime,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exp: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub neg: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sig: Option<String>,
    pub src: shrike_syntax::Did,
    pub uri: String,
    pub val: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ver: Option<i64>,
...
impl LabelDefsLabel {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("cts")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.cts.as_str())?;
            if self.exp.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("exp")?;
                if let Some(ref val) = self.exp {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.neg.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("neg")?;
                if let Some(ref val) = self.neg {
                    shrike_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.sig.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("sig")?;
                if let Some(ref val) = self.sig {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            shrike_cbor::Encoder::new(&mut *buf).encode_text("src")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.src.as_str())?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("uri")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.uri)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("val")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.val)?;
            if self.ver.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("ver")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(self.cts.as_str())?;
                pairs.push(("cts", vbuf));
            }
            if self.exp.is_some() {
                let mut vbuf = Vec::new();
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(self.src.as_str())?;
                pairs.push(("src", vbuf));
            }
            {
                let mut vbuf = Vec::new();
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.val)?;
                pairs.push(("val", vbuf));
            }
            if self.ver.is_some() {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_cts: Option<shrike_syntax::Datetime> = None;
        let mut field_exp: Option<shrike_syntax::Datetime> = None;
        let mut field_neg: Option<bool> = None;
        let mut field_sig: Option<String> = None;
        let mut field_src: Option<shrike_syntax::Did> = None;
        ...
        Ok(LabelDefsLabel {
            ...
            cts: field_cts.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'cts'".into())
            })?,
            exp: field_exp,
            neg: field_neg,
            sig: field_sig,
            src: field_src.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'src'".into())
            })?,
            uri: field_uri.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'uri'".into())
            })?,
            val: field_val.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'val'".into())
            })?,
            ver: field_ver,
...
impl LabelDefsLabelValueDefinition {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("blurs")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.blurs)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("locales")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.locales.len() as u64)?;
            for item in &self.locales {
                item.encode_cbor(buf)?;
            }
            shrike_cbor::Encoder::new(&mut *buf).encode_text("severity")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.severity)?;
            if self.adult_only.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("adultOnly")?;
                if let Some(ref val) = self.adult_only {
                    shrike_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            shrike_cbor::Encoder::new(&mut *buf).encode_text("identifier")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.identifier)?;
            if self.default_setting.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("defaultSetting")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.blurs)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.severity)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.identifier)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(LabelDefsLabelValueDefinition {
            blurs: field_blurs.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'blurs'".into())
            })?,
            locales: field_locales,
            severity: field_severity.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'severity'".into())
            })?,
            adult_only: field_adult_only,
            identifier: field_identifier.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'identifier'".into())
            })?,
...
impl LabelDefsLabelValueDefinitionStrings {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.description)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.description)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(LabelDefsLabelValueDefinitionStrings {
            ...
            description: field_description.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'description'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl LabelDefsSelfLabels {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("values")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.values.len() as u64)?;
