...
) -> Result<RepoListMissingBlobsOutput, shrike_xrpc::Error> {
    client
...
pub struct RepoListMissingBlobsRecordBlob {
    pub cid: String,
    pub record_uri: shrike_syntax::AtUri,
...
impl RepoListMissingBlobsRecordBlob {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.record_uri.as_str())?;
        } else {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(self.record_uri.as_str())?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(RepoListMissingBlobsRecordBlob {
            ...
            record_uri: field_record_uri.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'recordUri'".into())
            })?,
