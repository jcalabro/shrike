...
pub struct ModerationDefsAccountEvent {
    ...
    pub timestamp: shrike_syntax::Datetime,
...
impl ModerationDefsAccountEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("timestamp")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.timestamp.as_str())?;
        } else {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(self.timestamp.as_str())?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_timestamp: Option<shrike_syntax::Datetime> = None;
        ...
        Ok(ModerationDefsAccountEvent {
            ...
            timestamp: field_timestamp.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'timestamp'".into())
            })?,
...
pub struct ModerationDefsAccountHosting {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deleted_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reactivated_at: Option<shrike_syntax::Datetime>,
    pub status: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsAccountHosting {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.deleted_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("deletedAt")?;
            ...
            if self.reactivated_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("reactivatedAt")?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_deleted_at: Option<shrike_syntax::Datetime> = None;
        ...
        let mut field_reactivated_at: Option<shrike_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
...
impl ModerationDefsAccountStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.appeal_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("appealCount")?;
                if let Some(ref val) = self.appeal_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.report_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("reportCount")?;
                if let Some(ref val) = self.report_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.suspend_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("suspendCount")?;
                if let Some(ref val) = self.suspend_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.escalate_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("escalateCount")?;
                if let Some(ref val) = self.escalate_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.takedown_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("takedownCount")?;
...
pub struct ModerationDefsAccountStrike {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub first_strike_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_strike_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsAccountStrike {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.last_strike_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastStrikeAt")?;
                if let Some(ref val) = self.last_strike_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.first_strike_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("firstStrikeAt")?;
                if let Some(ref val) = self.first_strike_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.total_strike_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("totalStrikeCount")?;
                if let Some(ref val) = self.total_strike_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.active_strike_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("activeStrikeCount")?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_last_strike_at: Option<shrike_syntax::Datetime> = None;
        let mut field_first_strike_at: Option<shrike_syntax::Datetime> = None;
...
impl ModerationDefsAgeAssuranceOverrideEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.status)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("comment")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.comment)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            if self.access.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.comment)?;
                pairs.push(("comment", vbuf));
            }
            for (k, v) in &self.extra_cbor {
                pairs.push((k.as_str(), v.clone()));
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsAgeAssuranceOverrideEvent {
            ...
            comment: field_comment.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'comment'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ModerationDefsBlobView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.details.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("details")?;
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.created_at.as_str())?;
            if self.moderation.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("moderation")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.size)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.mime_type)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsBlobView {
            ...
            size: field_size.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'size'".into())
            })?,
            details: field_details,
            mime_type: field_mime_type.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'mimeType'".into())
            })?,
            created_at: field_created_at.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'createdAt'".into())
            })?,
...
impl ModerationDefsIdentityEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.pds_host.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("pdsHost")?;
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.timestamp.as_str())?;
            if self.tombstone.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("tombstone")?;
...
impl ModerationDefsModEventComment {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.sticky.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("sticky")?;
...
impl ModerationDefsModEventEmail {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.is_delivered.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("isDelivered")?;
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectLine")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.subject_line)?;
            if self.severity_level.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.subject_line)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsModEventEmail {
            ...
            subject_line: field_subject_line.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'subjectLine'".into())
            })?,
...
impl ModerationDefsModEventLabel {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("createLabelVals")?;
            shrike_cbor::Encoder::new(&mut *buf)
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("negateLabelVals")?;
            shrike_cbor::Encoder::new(&mut *buf)
...
impl ModerationDefsModEventMute {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("durationInHours")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.duration_in_hours)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            if self.comment.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.duration_in_hours)?;
                pairs.push(("durationInHours", vbuf));
            }
            for (k, v) in &self.extra_cbor {
                pairs.push((k.as_str(), v.clone()));
...
impl ModerationDefsModEventPriorityScore {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("score")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.score)?;
            if self.comment.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("comment")?;
                if let Some(ref val) = self.comment {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.score)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsModEventPriorityScore {
            score: field_score.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'score'".into())
            })?,
            comment: field_comment,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
impl ModerationDefsModEventReport {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reportType")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.report_type)?;
            if self.is_reporter_muted.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("isReporterMuted")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.report_type)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsModEventReport {
            ...
            report_type: field_report_type.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'reportType'".into())
            })?,
...
impl ModerationDefsModEventTag {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("add")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.add.len() as u64)?;
            for item in &self.add {
                shrike_cbor::Encoder::new(&mut *buf).encode_text(item)?;
            }
            shrike_cbor::Encoder::new(&mut *buf).encode_text("remove")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_array_header(self.remove.len() as u64)?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_array_header(self.add.len() as u64)?;
                for item in &self.add {
                    shrike_cbor::Encoder::new(&mut vbuf).encode_text(item)?;
                }
                pairs.push(("add", vbuf));
...
impl ModerationDefsModEventTakedown {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.target_services.is_empty() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("targetServices")?;
                shrike_cbor::Encoder::new(&mut *buf)
...
impl ModerationDefsModEventView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("event")?;
            self.event.encode_cbor(buf)?;
            if self.mod_tool.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("modTool")?;
            ...
            if self.creator_handle.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("creatorHandle")?;
                if let Some(ref val) = self.creator_handle {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.subject_handle.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectHandle")?;
                if let Some(ref val) = self.subject_handle {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectBlobCids")?;
            shrike_cbor::Encoder::new(&mut *buf)
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.id)?;
                pairs.push(("id", vbuf));
            }
            {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsModEventView {
            ...
            event: field_event.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'event'".into())
            })?,
...
impl ModerationDefsModEventViewDetail {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("createdBy")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.created_by.as_str())?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectBlobs")?;
            shrike_cbor::Encoder::new(&mut *buf)
...
impl ModerationDefsModeration {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.subject_status.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectStatus")?;
...
impl ModerationDefsRecordEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("op")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.op)?;
            if self.cid.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("cid")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.op)?;
                pairs.push(("op", vbuf));
            }
            if self.cid.is_some() {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsRecordEvent {
            op: field_op.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'op'".into())
            })?,
            cid: field_cid,
            comment: field_comment,
            timestamp: field_timestamp.ok_or_else(|| {
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsRecordView {
            ...
            moderation: field_moderation.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'moderation'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ModerationDefsRecordsStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.pending_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("pendingCount")?;
                if let Some(ref val) = self.pending_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.subject_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectCount")?;
                if let Some(ref val) = self.subject_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.total_reports.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("totalReports")?;
                if let Some(ref val) = self.total_reports {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.appealed_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("appealedCount")?;
                if let Some(ref val) = self.appealed_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.reported_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("reportedCount")?;
                if let Some(ref val) = self.reported_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.escalated_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("escalatedCount")?;
                if let Some(ref val) = self.escalated_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.processed_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("processedCount")?;
                if let Some(ref val) = self.processed_count {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.takendown_count.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("takendownCount")?;
...
impl ModerationDefsReporterStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("did")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.did.as_str())?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("recordReportCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.record_report_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("accountReportCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.account_report_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("labeledRecordCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.labeled_record_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("labeledAccountCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.labeled_account_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reportedRecordCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.reported_record_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reportedAccountCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.reported_account_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("takendownRecordCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.takendown_record_count)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("takendownAccountCount")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.takendown_account_count)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.record_report_count)?;
                pairs.push(("recordReportCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.account_report_count)?;
                pairs.push(("accountReportCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.labeled_record_count)?;
                pairs.push(("labeledRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.labeled_account_count)?;
                pairs.push(("labeledAccountCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.reported_record_count)?;
                pairs.push(("reportedRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.reported_account_count)?;
                pairs.push(("reportedAccountCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.takendown_record_count)?;
                pairs.push(("takendownRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.takendown_account_count)?;
...
pub struct ModerationDefsScheduledActionView {
    ...
    pub id: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_executed_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsScheduledActionView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.last_executed_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastExecutedAt")?;
                if let Some(ref val) = self.last_executed_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.execution_event_id.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("executionEventId")?;
                if let Some(ref val) = self.execution_event_id {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.last_failure_reason.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastFailureReason")?;
                if let Some(ref val) = self.last_failure_reason {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.randomize_execution.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("randomizeExecution")?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_execute_after: Option<shrike_syntax::Datetime> = None;
        let mut field_execute_until: Option<shrike_syntax::Datetime> = None;
        let mut field_last_executed_at: Option<shrike_syntax::Datetime> = None;
...
pub struct ModerationDefsSubjectStatusView {
    ...
    pub id: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_appealed_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reported_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reviewed_at: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reviewed_by: Option<shrike_syntax::Did>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mute_reporting_until: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mute_until: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suspend_until: Option<shrike_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tags: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsSubjectStatusView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.hosting.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("hosting")?;
            ...
            self.subject.encode_cbor(buf)?;
            if self.appealed.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("appealed")?;
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text(self.created_at.as_str())?;
            if self.mute_until.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("muteUntil")?;
                if let Some(ref val) = self.mute_until {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.takendown.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("takendown")?;
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("reviewState")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text(&self.review_state)?;
            if self.account_stats.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("accountStats")?;
                if let Some(ref val) = self.account_stats {
                    val.encode_cbor(buf)?;
                }
            }
            if self.records_stats.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("recordsStats")?;
                if let Some(ref val) = self.records_stats {
                    val.encode_cbor(buf)?;
                }
            }
            if self.suspend_until.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("suspendUntil")?;
                if let Some(ref val) = self.suspend_until {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.account_strike.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("accountStrike")?;
                if let Some(ref val) = self.account_strike {
                    val.encode_cbor(buf)?;
                }
            }
            if self.priority_score.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("priorityScore")?;
                if let Some(ref val) = self.priority_score {
                    shrike_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.last_appealed_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastAppealedAt")?;
                if let Some(ref val) = self.last_appealed_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reported_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastReportedAt")?;
                if let Some(ref val) = self.last_reported_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reviewed_at.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastReviewedAt")?;
                if let Some(ref val) = self.last_reviewed_at {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reviewed_by.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("lastReviewedBy")?;
            ...
            if self.age_assurance_state.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("ageAssuranceState")?;
                if let Some(ref val) = self.age_assurance_state {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.subject_repo_handle.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("subjectRepoHandle")?;
                if let Some(ref val) = self.subject_repo_handle {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.mute_reporting_until.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("muteReportingUntil")?;
                if let Some(ref val) = self.mute_reporting_until {
                    shrike_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.age_assurance_updated_by.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("ageAssuranceUpdatedBy")?;
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_text(&self.review_state)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        let mut field_created_at: Option<shrike_syntax::Datetime> = None;
        let mut field_mute_until: Option<shrike_syntax::Datetime> = None;
        ...
        let mut field_suspend_until: Option<shrike_syntax::Datetime> = None;
        let mut field_account_strike: Option<ModerationDefsAccountStrike> = None;
        let mut field_priority_score: Option<i64> = None;
        let mut field_last_appealed_at: Option<shrike_syntax::Datetime> = None;
        let mut field_last_reported_at: Option<shrike_syntax::Datetime> = None;
        let mut field_last_reviewed_at: Option<shrike_syntax::Datetime> = None;
        let mut field_last_reviewed_by: Option<shrike_syntax::Did> = None;
        let mut field_subject_blob_cids: Vec<String> = Vec::new();
        let mut field_age_assurance_state: Option<String> = None;
        let mut field_subject_repo_handle: Option<String> = None;
        let mut field_mute_reporting_until: Option<shrike_syntax::Datetime> = None;
        ...
        Ok(ModerationDefsSubjectStatusView {
            ...
            review_state: field_review_state.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'reviewState'".into())
            })?,
...
impl ModerationDefsSubjectView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.profile.is_some() {
                shrike_cbor::Encoder::new(&mut *buf).encode_text("profile")?;
...
impl ModerationDefsVideoDetails {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), shrike_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            shrike_cbor::Encoder::new(&mut *buf).encode_text("height")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.height)?;
            shrike_cbor::Encoder::new(&mut *buf).encode_text("length")?;
            shrike_cbor::Encoder::new(&mut *buf).encode_i64(self.length)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                shrike_cbor::Encoder::new(&mut vbuf).encode_i64(self.length)?;
    ...
    pub fn decode_cbor(decoder: &mut shrike_cbor::Decoder) -> Result<Self, shrike_cbor::CborError> {
        ...
        Ok(ModerationDefsVideoDetails {
            ...
            length: field_length.ok_or_else(|| {
                shrike_cbor::CborError::InvalidCbor("missing required field 'length'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
