...
impl AgeassuranceDefsConfig {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("regions")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.regions.len() as u64)?;
...
impl AgeassuranceDefsConfigRegion {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("rules")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.rules.len() as u64)?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.country_code)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("minAccessAge")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.min_access_age)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf)
                    .encode_array_header(self.rules.len() as u64)?;
                for item in &self.rules {
                    item.encode_cbor(&mut vbuf)?;
                }
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.country_code)?;
                pairs.push(("countryCode", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.min_access_age)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(AgeassuranceDefsConfigRegion {
            ...
            country_code: field_country_code.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'countryCode'".into())
            })?,
            min_access_age: field_min_access_age.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor(
                    "missing required field 'minAccessAge'".into(),
                )
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
impl AgeassuranceDefsConfigRegionRuleDefault {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.access)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.access)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(AgeassuranceDefsConfigRegionRuleDefault {
            access: field_access.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'access'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
pub struct AgeassuranceDefsConfigRegionRuleIfAccountNewerThan {
    pub access: AgeassuranceDefsAccess,
    pub date: ratproto_syntax::Datetime,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl AgeassuranceDefsConfigRegionRuleIfAccountNewerThan {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 2u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("date")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.date.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("access")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.access)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.date.as_str())?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_date: Option<ratproto_syntax::Datetime> = None;
        let mut field_access: Option<AgeassuranceDefsAccess> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
        ...
        Ok(AgeassuranceDefsConfigRegionRuleIfAccountNewerThan {
            date: field_date.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'date'".into())
            })?,
            access: field_access.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'access'".into())
            })?,
...
impl AgeassuranceDefsConfigRegionRuleIfAssuredOverAge {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 2u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("age")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.age)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("access")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.access)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.age)?;
                pairs.push(("age", vbuf));
            }
            {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(
        ...
        Ok(AgeassuranceDefsConfigRegionRuleIfAssuredOverAge {
            age: field_age.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'age'".into())
            })?,
            access: field_access.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'access'".into())
            })?,
...
pub struct AgeassuranceDefsStateMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub account_created_at: Option<ratproto_syntax::Datetime>,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl AgeassuranceDefsStateMetadata {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.account_created_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("accountCreatedAt")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_account_created_at: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
