...
impl ActorDefsAdultContentPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("enabled")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_bool(self.enabled)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_bool(self.enabled)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsAdultContentPref {
            enabled: field_enabled.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'enabled'".into())
            })?,
...
impl ActorDefsBskyAppProgressGuide {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("guide")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.guide)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.guide)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsBskyAppProgressGuide {
            guide: field_guide.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'guide'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ActorDefsBskyAppStatePref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if !self.nuxs.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("nuxs")?;
                ratproto_cbor::Encoder::new(&mut *buf)
                    .encode_array_header(self.nuxs.len() as u64)?;
                for item in &self.nuxs {
                    item.encode_cbor(buf)?;
                }
            }
            if !self.queued_nudges.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("queuedNudges")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if self.active_progress_guide.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("activeProgressGuide")?;
...
pub struct ActorDefsContentLabelPref {
    pub label: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub labeler_did: Option<ratproto_syntax::Did>,
...
impl ActorDefsContentLabelPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("label")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.label)?;
            if self.labeler_did.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("labelerDid")?;
                if let Some(ref val) = self.labeler_did {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("visibility")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.visibility)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.label)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.visibility)?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_labeler_did: Option<ratproto_syntax::Did> = None;
        ...
        Ok(ActorDefsContentLabelPref {
            label: field_label.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'label'".into())
            })?,
            labeler_did: field_labeler_did,
            visibility: field_visibility.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'visibility'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ActorDefsDeclaredAgePref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.is_over_age13.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isOverAge13")?;
                if let Some(ref val) = self.is_over_age13 {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.is_over_age16.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isOverAge16")?;
                if let Some(ref val) = self.is_over_age16 {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.is_over_age18.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isOverAge18")?;
...
impl ActorDefsFeedViewPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("feed")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.feed)?;
            if self.hide_replies.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideReplies")?;
                if let Some(ref val) = self.hide_replies {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.hide_reposts.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideReposts")?;
                if let Some(ref val) = self.hide_reposts {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.hide_quote_posts.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideQuotePosts")?;
                if let Some(ref val) = self.hide_quote_posts {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.hide_replies_by_like_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideRepliesByLikeCount")?;
                if let Some(ref val) = self.hide_replies_by_like_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.hide_replies_by_unfollowed.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideRepliesByUnfollowed")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.feed)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsFeedViewPref {
            feed: field_feed.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'feed'".into())
            })?,
...
pub struct ActorDefsHiddenPostsPref {
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub items: Vec<ratproto_syntax::AtUri>,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ActorDefsHiddenPostsPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("items")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.items.len() as u64)?;
            ...
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf)
                    .encode_array_header(self.items.len() as u64)?;
                for item in &self.items {
    ...
    pub fn decode_cbor(
        ...
        let mut field_items: Vec<ratproto_syntax::AtUri> = Vec::new();
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
            ...
            match key {
                "items" => {
                    if let ratproto_cbor::Value::Array(items) = value {
                        for item in items {
                            if let ratproto_cbor::Value::Text(s) = item {
                                field_items.push(ratproto_syntax::AtUri::try_from(s).map_err(
...
impl ActorDefsInterestsPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.tags.len() as u64)?;
...
impl ActorDefsKnownFollowers {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("followers")?;
            ratproto_cbor::Encoder::new(&mut *buf)
...
impl ActorDefsLabelersPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("labelers")?;
            ratproto_cbor::Encoder::new(&mut *buf)
...
impl ActorDefsLiveEventPreferences {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.hide_all_feeds.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideAllFeeds")?;
                if let Some(ref val) = self.hide_all_feeds {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if !self.hidden_feed_ids.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hiddenFeedIds")?;
                ratproto_cbor::Encoder::new(&mut *buf)
...
pub struct ActorDefsMutedWord {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub expires_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ActorDefsMutedWord {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("targets")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.targets.len() as u64)?;
            for item in &self.targets {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text(item)?;
            }
            if self.expires_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("expiresAt")?;
                if let Some(ref val) = self.expires_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.actor_target.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("actorTarget")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_expires_at: Option<ratproto_syntax::Datetime> = None;
...
impl ActorDefsNux {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.data.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("data")?;
                if let Some(ref val) = self.data {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("completed")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_bool(self.completed)?;
            if self.expires_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("expiresAt")?;
                if let Some(ref val) = self.expires_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_bool(self.completed)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsNux {
            ...
            completed: field_completed.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'completed'".into())
            })?,
            expires_at: field_expires_at,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
pub struct ActorDefsPersonalDetailsPref {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub birth_date: Option<ratproto_syntax::Datetime>,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ActorDefsPersonalDetailsPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.birth_date.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("birthDate")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_birth_date: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
...
impl ActorDefsPostInteractionSettingsPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if !self.threadgate_allow_rules.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("threadgateAllowRules")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if !self.postgate_embedding_rules.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("postgateEmbeddingRules")?;
                ratproto_cbor::Encoder::new(&mut *buf)
...
impl ActorDefsProfileAssociated {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.germ.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("germ")?;
            ...
            if self.labeler.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("labeler")?;
                if let Some(ref val) = self.labeler {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.feedgens.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("feedgens")?;
                if let Some(ref val) = self.feedgens {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.starter_packs.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("starterPacks")?;
...
impl ActorDefsProfileAssociatedChat {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 1u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("allowIncoming")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.allow_incoming)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.allow_incoming)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsProfileAssociatedChat {
            allow_incoming: field_allow_incoming.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor(
                    "missing required field 'allowIncoming'".into(),
                )
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
impl ActorDefsProfileAssociatedGerm {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 2u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("messageMeUrl")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.message_me_url)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("showButtonTo")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.show_button_to)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.message_me_url)?;
                pairs.push(("messageMeUrl", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.show_button_to)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsProfileAssociatedGerm {
            message_me_url: field_message_me_url.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor(
                    "missing required field 'messageMeUrl'".into(),
                )
            })?,
            show_button_to: field_show_button_to.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor(
                    "missing required field 'showButtonTo'".into(),
                )
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
pub struct ActorDefsProfileView {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub indexed_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
impl ActorDefsProfileView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.associated.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("associated")?;
            ...
            if self.verification.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("verification")?;
...
impl ActorDefsProfileViewDetailed {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.posts_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("postsCount")?;
            ...
            if self.follows_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("followsCount")?;
            ...
            if self.followers_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("followersCount")?;
...
impl ActorDefsSavedFeed {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_bool(self.pinned)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_bool(self.pinned)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ActorDefsSavedFeed {
            ...
            pinned: field_pinned.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'pinned'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
pub struct ActorDefsSavedFeedsPref {
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub pinned: Vec<ratproto_syntax::AtUri>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub saved: Vec<ratproto_syntax::AtUri>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ActorDefsSavedFeedsPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("saved")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.saved.len() as u64)?;
            for item in &self.saved {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text(item.as_str())?;
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("pinned")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.pinned.len() as u64)?;
            for item in &self.pinned {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text(item.as_str())?;
            }
            if self.timeline_index.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("timelineIndex")?;
            ...
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf)
                    .encode_array_header(self.saved.len() as u64)?;
                for item in &self.saved {
                    ratproto_cbor::Encoder::new(&mut vbuf).encode_text(item.as_str())?;
                }
    ...
    pub fn decode_cbor(
        ...
        let mut field_saved: Vec<ratproto_syntax::AtUri> = Vec::new();
        let mut field_pinned: Vec<ratproto_syntax::AtUri> = Vec::new();
            ...
            match key {
                "saved" => {
                    if let ratproto_cbor::Value::Array(items) = value {
                        for item in items {
                            if let ratproto_cbor::Value::Text(s) = item {
                                field_saved.push(ratproto_syntax::AtUri::try_from(s).map_err(
                                    |e| ratproto_cbor::CborError::InvalidCbor(e.to_string()),
                                )?);
                            } else {
                                return Err(ratproto_cbor::CborError::InvalidCbor(
                ...
                "pinned" => {
                    if let ratproto_cbor::Value::Array(items) = value {
                        for item in items {
                            if let ratproto_cbor::Value::Text(s) = item {
                                field_pinned.push(ratproto_syntax::AtUri::try_from(s).map_err(
                                    |e| ratproto_cbor::CborError::InvalidCbor(e.to_string()),
                                )?);
                            } else {
                                return Err(ratproto_cbor::CborError::InvalidCbor(
...
impl ActorDefsStatusView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.is_active.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isActive")?;
            ...
            if self.is_disabled.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isDisabled")?;
...
impl ActorDefsThreadViewPref {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.sort.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("sort")?;
...
impl ActorDefsVerificationPrefs {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.hide_badges.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hideBadges")?;
...
impl ActorDefsVerificationState {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 3u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("verifications")?;
            ratproto_cbor::Encoder::new(&mut *buf)
                .encode_array_header(self.verifications.len() as u64)?;
            for item in &self.verifications {
                item.encode_cbor(buf)?;
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("verifiedStatus")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.verified_status)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("trustedVerifierStatus")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.trusted_verifier_status)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.verified_status)?;
                pairs.push(("verifiedStatus", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf)
                    .encode_text(&self.trusted_verifier_status)?;
...
pub struct ActorDefsVerificationView {
    ...
    pub is_valid: bool,
    pub issuer: ratproto_syntax::Did,
...
impl ActorDefsVerificationView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("issuer")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.issuer.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("isValid")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_bool(self.is_valid)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("createdAt")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.issuer.as_str())?;
                pairs.push(("issuer", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_bool(self.is_valid)?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_uri: Option<ratproto_syntax::AtUri> = None;
        let mut field_issuer: Option<ratproto_syntax::Did> = None;
        ...
        Ok(ActorDefsVerificationView {
            ...
            issuer: field_issuer.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'issuer'".into())
            })?,
            is_valid: field_is_valid.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'isValid'".into())
            })?,
...
pub struct ActorDefsViewerState {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub blocking: Option<ratproto_syntax::AtUri>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub blocking_by_list: Option<crate::app::bsky::GraphDefsListViewBasic>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub followed_by: Option<ratproto_syntax::AtUri>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub following: Option<ratproto_syntax::AtUri>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ActorDefsViewerState {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.muted.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("muted")?;
                if let Some(ref val) = self.muted {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.blocking.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("blocking")?;
                if let Some(ref val) = self.blocking {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.blocked_by.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("blockedBy")?;
                if let Some(ref val) = self.blocked_by {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.following.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("following")?;
                if let Some(ref val) = self.following {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.followed_by.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("followedBy")?;
                if let Some(ref val) = self.followed_by {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.muted_by_list.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("mutedByList")?;
                if let Some(ref val) = self.muted_by_list {
                    val.encode_cbor(buf)?;
                }
            }
            if self.blocking_by_list.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("blockingByList")?;
                if let Some(ref val) = self.blocking_by_list {
                    val.encode_cbor(buf)?;
                }
            }
            if self.known_followers.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("knownFollowers")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_blocking: Option<ratproto_syntax::AtUri> = None;
        let mut field_blocked_by: Option<bool> = None;
        let mut field_following: Option<ratproto_syntax::AtUri> = None;
        let mut field_followed_by: Option<ratproto_syntax::AtUri> = None;
