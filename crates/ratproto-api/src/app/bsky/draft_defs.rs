...
pub struct DraftDefsDraft {
    ...
    pub langs: Vec<ratproto_syntax::Language>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
impl DraftDefsDraft {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.langs.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("langs")?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("posts")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.posts.len() as u64)?;
            for item in &self.posts {
                item.encode_cbor(buf)?;
            }
            if self.device_id.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("deviceId")?;
                if let Some(ref val) = self.device_id {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.device_name.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("deviceName")?;
                if let Some(ref val) = self.device_name {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if !self.threadgate_allow.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("threadgateAllow")?;
                ratproto_cbor::Encoder::new(&mut *buf)
    ...
    pub fn decode_cbor(
        ...
        let mut field_langs: Vec<ratproto_syntax::Language> = Vec::new();
                    ...
                    if let ratproto_cbor::Value::Array(items) = value {
                        for item in items {
                            if let ratproto_cbor::Value::Text(s) = item {
                                field_langs.push(ratproto_syntax::Language::try_from(s).map_err(
...
pub struct DraftDefsDraftEmbedCaption {
    pub content: String,
    pub lang: ratproto_syntax::Language,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl DraftDefsDraftEmbedCaption {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.lang.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("content")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.content)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.lang.as_str())?;
                pairs.push(("lang", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.content)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(DraftDefsDraftEmbedCaption {
            lang: field_lang.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'lang'".into())
            })?,
            content: field_content.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'content'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl DraftDefsDraftEmbedImage {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("localRef")?;
    ...
    pub fn decode_cbor(
        ...
        Ok(DraftDefsDraftEmbedImage {
            ...
            local_ref: field_local_ref.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'localRef'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl DraftDefsDraftEmbedVideo {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.captions.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("captions")?;
                ratproto_cbor::Encoder::new(&mut *buf)
...
impl DraftDefsDraftPost {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("text")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.text)?;
            if self.labels.is_some() {
            ...
            if !self.embed_images.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("embedImages")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if !self.embed_videos.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("embedVideos")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if !self.embed_records.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("embedRecords")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if !self.embed_externals.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("embedExternals")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.text)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(DraftDefsDraftPost {
            text: field_text.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'text'".into())
            })?,
            labels: field_labels,
...
impl DraftDefsDraftView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("draft")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_id: Option<ratproto_syntax::Tid> = None;
        ...
        Ok(DraftDefsDraftView {
            ...
            draft: field_draft.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'draft'".into())
            })?,
