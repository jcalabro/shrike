...
pub struct LabelerService {
    ...
    pub policies: crate::app::bsky::LabelerDefsLabelerPolicies,
...
impl LabelerService {
    ...
    pub fn decode_cbor(
        ...
        let mut field_policies: Option<crate::app::bsky::LabelerDefsLabelerPolicies> = None;
        ...
        for (key, value) in entries {
            match key {
                ...
                "policies" => {
                    ...
                    let mut dec = ratproto_cbor::Decoder::new(&raw);
                    field_policies = Some(
                        crate::app::bsky::LabelerDefsLabelerPolicies::decode_cbor(&mut dec)?,
                    );
                }
                "createdAt" => {
