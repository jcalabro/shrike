...
pub struct ModerationDefsAccountEvent {
    ...
    pub timestamp: ratproto_syntax::Datetime,
...
impl ModerationDefsAccountEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("timestamp")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.timestamp.as_str())?;
        } else {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.timestamp.as_str())?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_timestamp: Option<ratproto_syntax::Datetime> = None;
        ...
        Ok(ModerationDefsAccountEvent {
            ...
            timestamp: field_timestamp.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'timestamp'".into())
            })?,
...
pub struct ModerationDefsAccountHosting {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deactivated_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deleted_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reactivated_at: Option<ratproto_syntax::Datetime>,
    pub status: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsAccountHosting {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.deleted_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("deletedAt")?;
            ...
            if self.deactivated_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("deactivatedAt")?;
                if let Some(ref val) = self.deactivated_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.reactivated_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("reactivatedAt")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_deleted_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_updated_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_deactivated_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_reactivated_at: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
...
impl ModerationDefsAccountStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.appeal_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("appealCount")?;
                if let Some(ref val) = self.appeal_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.report_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("reportCount")?;
                if let Some(ref val) = self.report_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.suspend_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("suspendCount")?;
                if let Some(ref val) = self.suspend_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.escalate_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("escalateCount")?;
                if let Some(ref val) = self.escalate_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.takedown_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("takedownCount")?;
...
pub struct ModerationDefsAccountStrike {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub first_strike_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_strike_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsAccountStrike {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.last_strike_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastStrikeAt")?;
                if let Some(ref val) = self.last_strike_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.first_strike_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("firstStrikeAt")?;
                if let Some(ref val) = self.first_strike_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.total_strike_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("totalStrikeCount")?;
                if let Some(ref val) = self.total_strike_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.active_strike_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("activeStrikeCount")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_last_strike_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_first_strike_at: Option<ratproto_syntax::Datetime> = None;
...
pub struct ModerationDefsAgeAssuranceEvent {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub access: Option<crate::app::bsky::AgeassuranceDefsAccess>,
...
impl ModerationDefsAgeAssuranceEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.access.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("access")?;
            ...
            if self.region_code.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("regionCode")?;
                if let Some(ref val) = self.region_code {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.country_code.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("countryCode")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_access: Option<crate::app::bsky::AgeassuranceDefsAccess> = None;
...
impl ModerationDefsAgeAssuranceOverrideEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.status)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("comment")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.comment)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            if self.access.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.comment)?;
                pairs.push(("comment", vbuf));
            }
            for (k, v) in &self.extra_cbor {
                pairs.push((k.as_str(), v.clone()));
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsAgeAssuranceOverrideEvent {
            ...
            comment: field_comment.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'comment'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ModerationDefsBlobView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.details.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("details")?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.created_at.as_str())?;
            if self.moderation.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("moderation")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.size)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.mime_type)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsBlobView {
            ...
            size: field_size.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'size'".into())
            })?,
            details: field_details,
            mime_type: field_mime_type.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'mimeType'".into())
            })?,
            created_at: field_created_at.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'createdAt'".into())
            })?,
...
impl ModerationDefsIdentityEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.pds_host.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("pdsHost")?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.timestamp.as_str())?;
            if self.tombstone.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("tombstone")?;
...
impl ModerationDefsImageDetails {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            let count = 2u64;
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("width")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.width)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("height")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.height)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.width)?;
                pairs.push(("width", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.height)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsImageDetails {
            width: field_width.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'width'".into())
            })?,
            height: field_height.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'height'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ModerationDefsModEventAcknowledge {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.acknowledge_account_subjects.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("acknowledgeAccountSubjects")?;
...
impl ModerationDefsModEventComment {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.sticky.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("sticky")?;
...
pub struct ModerationDefsModEventEmail {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub strike_expires_at: Option<ratproto_syntax::Datetime>,
...
impl ModerationDefsModEventEmail {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.content.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("content")?;
                if let Some(ref val) = self.content {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if !self.policies.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("policies")?;
            ...
            if self.is_delivered.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isDelivered")?;
                if let Some(ref val) = self.is_delivered {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if self.strike_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("strikeCount")?;
                if let Some(ref val) = self.strike_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectLine")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.subject_line)?;
            if self.severity_level.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("severityLevel")?;
                if let Some(ref val) = self.severity_level {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.strike_expires_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("strikeExpiresAt")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.subject_line)?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_strike_expires_at: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
        ...
        Ok(ModerationDefsModEventEmail {
            ...
            subject_line: field_subject_line.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'subjectLine'".into())
            })?,
...
impl ModerationDefsModEventLabel {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("createLabelVals")?;
            ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if self.duration_in_hours.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("durationInHours")?;
                if let Some(ref val) = self.duration_in_hours {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("negateLabelVals")?;
            ratproto_cbor::Encoder::new(&mut *buf)
...
impl ModerationDefsModEventMute {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("durationInHours")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.duration_in_hours)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            if self.comment.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.duration_in_hours)?;
                pairs.push(("durationInHours", vbuf));
            }
            for (k, v) in &self.extra_cbor {
                pairs.push((k.as_str(), v.clone()));
...
impl ModerationDefsModEventPriorityScore {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("score")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.score)?;
            if self.comment.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("comment")?;
                if let Some(ref val) = self.comment {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.score)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsModEventPriorityScore {
            score: field_score.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'score'".into())
            })?,
            comment: field_comment,
            extra: std::collections::HashMap::new(),
            extra_cbor,
...
pub struct ModerationDefsModEventReport {
    ...
    pub report_type: crate::com::atproto::ModerationDefsReasonType,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ModerationDefsModEventReport {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("reportType")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.report_type)?;
            if self.is_reporter_muted.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("isReporterMuted")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.report_type)?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_comment: Option<String> = None;
        let mut field_report_type: Option<crate::com::atproto::ModerationDefsReasonType> = None;
        ...
        Ok(ModerationDefsModEventReport {
            ...
            report_type: field_report_type.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'reportType'".into())
            })?,
...
impl ModerationDefsModEventTag {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("add")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.add.len() as u64)?;
            for item in &self.add {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text(item)?;
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("remove")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.remove.len() as u64)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_array_header(self.add.len() as u64)?;
                for item in &self.add {
                    ratproto_cbor::Encoder::new(&mut vbuf).encode_text(item)?;
                }
                pairs.push(("add", vbuf));
...
impl ModerationDefsModEventTakedown {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.target_services.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("targetServices")?;
                ratproto_cbor::Encoder::new(&mut *buf)
...
pub enum ModerationDefsModEventViewSubjectUnion {
    ...
    ConvoDefsMessageRef(Box<crate::chat::bsky::ConvoDefsMessageRef>),
    Unknown(crate::UnknownUnionVariant),
}
    ...
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        match type_str {
            ...
            "chat.bsky.convo.defs#messageRef" => {
                let inner: crate::chat::bsky::ConvoDefsMessageRef =
                    serde_json::from_value(value).map_err(serde::de::Error::custom)?;
...
impl ModerationDefsModEventViewSubjectUnion {
    ...
    pub fn decode_cbor(
        ...
        match type_str {
            ...
            "chat.bsky.convo.defs#messageRef" => {
                let mut dec = ratproto_cbor::Decoder::new(raw);
                let inner = crate::chat::bsky::ConvoDefsMessageRef::decode_cbor(&mut dec)?;
                Ok(ModerationDefsModEventViewSubjectUnion::ConvoDefsMessageRef(
                    Box::new(inner),
                ))
            }
...
impl ModerationDefsModEventView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.mod_tool.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("modTool")?;
            ...
            if self.creator_handle.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("creatorHandle")?;
                if let Some(ref val) = self.creator_handle {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.subject_handle.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectHandle")?;
                if let Some(ref val) = self.subject_handle {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectBlobCids")?;
            ratproto_cbor::Encoder::new(&mut *buf)
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsModEventView {
            ...
            event: field_event.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'event'".into())
            })?,
        ...
        match self {
            ...
            ModerationDefsModEventViewDetailEventUnion::Unknown(v) => {
                if let Some(ref data) = v.cbor {
                    ...
                    Err(ratproto_cbor::CborError::InvalidCbor("no CBOR data for unknown union variant".into()))
                }
            }
        }
    }
...
impl ModerationDefsModEventViewDetail {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("createdBy")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.created_by.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectBlobs")?;
            ratproto_cbor::Encoder::new(&mut *buf)
...
impl ModerationDefsModeration {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.subject_status.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectStatus")?;
...
impl ModerationDefsRecordEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("op")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.op)?;
            if self.cid.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("cid")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.op)?;
                pairs.push(("op", vbuf));
            }
            if self.cid.is_some() {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsRecordEvent {
            op: field_op.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'op'".into())
            })?,
            cid: field_cid,
            comment: field_comment,
            timestamp: field_timestamp.ok_or_else(|| {
...
impl ModerationDefsRecordView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("blobCids")?;
            ratproto_cbor::Encoder::new(&mut *buf)
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsRecordView {
            ...
            moderation: field_moderation.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'moderation'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ModerationDefsRecordsStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            if self.pending_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("pendingCount")?;
                if let Some(ref val) = self.pending_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.subject_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectCount")?;
                if let Some(ref val) = self.subject_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.total_reports.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("totalReports")?;
                if let Some(ref val) = self.total_reports {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.appealed_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("appealedCount")?;
                if let Some(ref val) = self.appealed_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.reported_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("reportedCount")?;
                if let Some(ref val) = self.reported_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.escalated_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("escalatedCount")?;
                if let Some(ref val) = self.escalated_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.processed_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("processedCount")?;
                if let Some(ref val) = self.processed_count {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.takendown_count.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("takendownCount")?;
...
pub struct ModerationDefsRepoView {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub threat_signatures: Vec<crate::com::atproto::AdminDefsThreatSignature>,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ModerationDefsRepoView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.indexed_at.as_str())?;
            if self.invited_by.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("invitedBy")?;
                if let Some(ref val) = self.invited_by {
                    val.encode_cbor(buf)?;
                }
            }
            if self.invite_note.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("inviteNote")?;
            ...
            if self.invites_disabled.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("invitesDisabled")?;
                if let Some(ref val) = self.invites_disabled {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_bool(*val)?;
                }
            }
            if !self.threat_signatures.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("threatSignatures")?;
                ratproto_cbor::Encoder::new(&mut *buf)
    ...
    pub fn decode_cbor(
        ...
        let mut field_threat_signatures: Vec<crate::com::atproto::AdminDefsThreatSignature> =
            Vec::new();
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
                    ...
                    if let ratproto_cbor::Value::Array(items) = value {
                        for item in items {
                            ...
                            field_threat_signatures.push(
                                crate::com::atproto::AdminDefsThreatSignature::decode_cbor(
                                    &mut dec,
                                )?,
                            );
                        }
...
pub struct ModerationDefsRepoViewDetail {
    ...
    pub email: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub email_confirmed_at: Option<ratproto_syntax::Datetime>,
    pub handle: ratproto_syntax::Handle,
    pub indexed_at: ratproto_syntax::Datetime,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub invite_note: Option<String>,
...
impl ModerationDefsRepoViewDetail {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.invites.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("invites")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if self.email_confirmed_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("emailConfirmedAt")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_deactivated_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_invites_disabled: Option<bool> = None;
        let mut field_email_confirmed_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_threat_signatures: Vec<crate::com::atproto::AdminDefsThreatSignature> =
            Vec::new();
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
...
impl ModerationDefsReporterStats {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("did")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.did.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("recordReportCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.record_report_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("accountReportCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.account_report_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("labeledRecordCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.labeled_record_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("labeledAccountCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.labeled_account_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("reportedRecordCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.reported_record_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("reportedAccountCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.reported_account_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("takendownRecordCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.takendown_record_count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("takendownAccountCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.takendown_account_count)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.record_report_count)?;
                pairs.push(("recordReportCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.account_report_count)?;
                pairs.push(("accountReportCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.labeled_record_count)?;
                pairs.push(("labeledRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.labeled_account_count)?;
                pairs.push(("labeledAccountCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.reported_record_count)?;
                pairs.push(("reportedRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.reported_account_count)?;
                pairs.push(("reportedAccountCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.takendown_record_count)?;
                pairs.push(("takendownRecordCount", vbuf));
            }
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.takendown_account_count)?;
...
pub struct ModerationDefsScheduleTakedownEvent {
    ...
    pub comment: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub execute_after: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub execute_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub execute_until: Option<ratproto_syntax::Datetime>,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ModerationDefsScheduleTakedownEvent {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.execute_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("executeAt")?;
                if let Some(ref val) = self.execute_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.execute_after.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("executeAfter")?;
                if let Some(ref val) = self.execute_after {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.execute_until.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("executeUntil")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_comment: Option<String> = None;
        let mut field_execute_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_execute_after: Option<ratproto_syntax::Datetime> = None;
        let mut field_execute_until: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
...
pub struct ModerationDefsScheduledActionView {
    ...
    pub id: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_executed_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsScheduledActionView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.last_executed_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastExecutedAt")?;
                if let Some(ref val) = self.last_executed_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.execution_event_id.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("executionEventId")?;
                if let Some(ref val) = self.execution_event_id {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.last_failure_reason.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastFailureReason")?;
                if let Some(ref val) = self.last_failure_reason {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.randomize_execution.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("randomizeExecution")?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_execute_after: Option<ratproto_syntax::Datetime> = None;
        let mut field_execute_until: Option<ratproto_syntax::Datetime> = None;
        let mut field_last_executed_at: Option<ratproto_syntax::Datetime> = None;
...
pub struct ModerationDefsSubjectStatusView {
    ...
    pub id: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_appealed_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reported_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reviewed_at: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_reviewed_by: Option<ratproto_syntax::Did>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mute_reporting_until: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mute_until: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suspend_until: Option<ratproto_syntax::Datetime>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tags: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModerationDefsSubjectStatusView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.id)?;
            if !self.tags.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("tags")?;
                ratproto_cbor::Encoder::new(&mut *buf)
            ...
            if self.hosting.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("hosting")?;
            ...
            self.subject.encode_cbor(buf)?;
            if self.appealed.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("appealed")?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.created_at.as_str())?;
            if self.mute_until.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("muteUntil")?;
                if let Some(ref val) = self.mute_until {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.takendown.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("takendown")?;
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("reviewState")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.review_state)?;
            if self.account_stats.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("accountStats")?;
                if let Some(ref val) = self.account_stats {
                    val.encode_cbor(buf)?;
                }
            }
            if self.records_stats.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("recordsStats")?;
                if let Some(ref val) = self.records_stats {
                    val.encode_cbor(buf)?;
                }
            }
            if self.suspend_until.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("suspendUntil")?;
                if let Some(ref val) = self.suspend_until {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.account_strike.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("accountStrike")?;
                if let Some(ref val) = self.account_strike {
                    val.encode_cbor(buf)?;
                }
            }
            if self.priority_score.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("priorityScore")?;
                if let Some(ref val) = self.priority_score {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_i64(*val)?;
                }
            }
            if self.last_appealed_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastAppealedAt")?;
                if let Some(ref val) = self.last_appealed_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reported_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastReportedAt")?;
                if let Some(ref val) = self.last_reported_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reviewed_at.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastReviewedAt")?;
                if let Some(ref val) = self.last_reviewed_at {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.last_reviewed_by.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastReviewedBy")?;
            ...
            if self.age_assurance_state.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("ageAssuranceState")?;
                if let Some(ref val) = self.age_assurance_state {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.subject_repo_handle.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("subjectRepoHandle")?;
                if let Some(ref val) = self.subject_repo_handle {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val)?;
                }
            }
            if self.mute_reporting_until.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("muteReportingUntil")?;
                if let Some(ref val) = self.mute_reporting_until {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            if self.age_assurance_updated_by.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("ageAssuranceUpdatedBy")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.review_state)?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_created_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_mute_until: Option<ratproto_syntax::Datetime> = None;
        ...
        let mut field_suspend_until: Option<ratproto_syntax::Datetime> = None;
        let mut field_account_strike: Option<ModerationDefsAccountStrike> = None;
        let mut field_priority_score: Option<i64> = None;
        let mut field_last_appealed_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_last_reported_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_last_reviewed_at: Option<ratproto_syntax::Datetime> = None;
        let mut field_last_reviewed_by: Option<ratproto_syntax::Did> = None;
        let mut field_subject_blob_cids: Vec<String> = Vec::new();
        let mut field_age_assurance_state: Option<String> = None;
        let mut field_subject_repo_handle: Option<String> = None;
        let mut field_mute_reporting_until: Option<ratproto_syntax::Datetime> = None;
        ...
        Ok(ModerationDefsSubjectStatusView {
            ...
            review_state: field_review_state.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'reviewState'".into())
            })?,
...
pub struct ModerationDefsSubjectView {
    ...
    pub subject: String,
    pub r#type: crate::com::atproto::ModerationDefsSubjectType,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ModerationDefsSubjectView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("subject")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.subject)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            if self.repo.is_some() {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.r#type)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.subject)?;
                pairs.push(("subject", vbuf));
            }
            for (k, v) in &self.extra_cbor {
                pairs.push((k.as_str(), v.clone()));
    ...
    pub fn decode_cbor(
        ...
        let mut field_type: Option<crate::com::atproto::ModerationDefsSubjectType> = None;
        ...
        Ok(ModerationDefsSubjectView {
            ...
            r#type: field_type.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'type'".into())
            })?,
            record: field_record,
            status: field_status,
...
impl ModerationDefsVideoDetails {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("height")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.height)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("length")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.length)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.length)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ModerationDefsVideoDetails {
            ...
            length: field_length.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'length'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
