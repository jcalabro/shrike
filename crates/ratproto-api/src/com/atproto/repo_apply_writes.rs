...
pub struct RepoApplyWritesCreate {
    ...
    pub rkey: Option<ratproto_syntax::RecordKey>,
...
impl RepoApplyWritesCreate {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.rkey.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("rkey")?;
                if let Some(ref val) = self.rkey {
                    ratproto_cbor::Encoder::new(&mut *buf).encode_text(val.as_str())?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("collection")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.collection.as_str())?;
        } else {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.collection.as_str())?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_rkey: Option<ratproto_syntax::RecordKey> = None;
        let mut field_collection: Option<ratproto_syntax::Nsid> = None;
            ...
            match key {
                "rkey" => {
                    if let ratproto_cbor::Value::Text(s) = value {
                        field_rkey =
                            Some(ratproto_syntax::RecordKey::try_from(s).map_err(|e| {
        ...
        Ok(RepoApplyWritesCreate {
            ...
            collection: field_collection.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'collection'".into())
            })?,
...
impl RepoApplyWritesCreateResult {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if self.validation_status.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("validationStatus")?;
...
impl RepoApplyWritesDelete {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_map_header(count)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("rkey")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.rkey.as_str())?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("collection")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.collection.as_str())?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.rkey.as_str())?;
                pairs.push(("rkey", vbuf));
            }
            {
                let mut vbuf = Vec::new();
    ...
    pub fn decode_cbor(
        ...
        Ok(RepoApplyWritesDelete {
            rkey: field_rkey.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'rkey'".into())
            })?,
            collection: field_collection.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'collection'".into())
            })?,
...
impl RepoApplyWritesInputWritesUnion {
    ...
    pub fn decode_cbor(
        ...
        match type_str {
            ...
            other => Err(ratproto_cbor::CborError::InvalidCbor(format!(
                "unknown type {:?} in closed union RepoApplyWritesInputWritesUnion",
                other
            ))),
        }
...
) -> Result<RepoApplyWritesOutput, ratproto_xrpc::Error> {
    client
