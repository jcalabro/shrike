...
impl ConvoDefsConvoView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_bool(self.muted)?;
            if self.status.is_some() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("members")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_array_header(self.members.len() as u64)?;
            for item in &self.members {
                item.encode_cbor(buf)?;
            }
            if self.last_message.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastMessage")?;
                if let Some(ref val) = self.last_message {
                    val.encode_cbor(buf)?;
                }
            }
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("unreadCount")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_i64(self.unread_count)?;
            if self.last_reaction.is_some() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("lastReaction")?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_bool(self.muted)?;
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_i64(self.unread_count)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ConvoDefsConvoView {
            ...
            muted: field_muted.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'muted'".into())
            })?,
            status: field_status,
            members: field_members,
            last_message: field_last_message,
            unread_count: field_unread_count.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'unreadCount'".into())
            })?,
...
pub struct ConvoDefsDeletedMessageView {
    ...
    pub sent_at: ratproto_syntax::Datetime,
    /// Extra fields not defined in the schema (JSON).
    #[serde(flatten)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
    /// Extra fields not defined in the schema (CBOR).
...
impl ConvoDefsDeletedMessageView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("rev")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.rev)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("sender")?;
            self.sender.encode_cbor(buf)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("sentAt")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.sent_at.as_str())?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(self.sent_at.as_str())?;
    ...
    pub fn decode_cbor(
        ...
        let mut field_sent_at: Option<ratproto_syntax::Datetime> = None;
        let mut extra_cbor: Vec<(String, Vec<u8>)> = Vec::new();
        ...
        Ok(ConvoDefsDeletedMessageView {
            ...
            sender: field_sender.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'sender'".into())
            })?,
            sent_at: field_sent_at.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'sentAt'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ConvoDefsLogAcceptConvo {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("rev")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.rev)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("convoId")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.convo_id)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.convo_id)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ConvoDefsLogAcceptConvo {
            ...
            convo_id: field_convo_id.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'convoId'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ConvoDefsLogAddReaction {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("reaction")?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ConvoDefsLogAddReaction {
            ...
            message: field_message.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'message'".into())
            })?,
            reaction: field_reaction.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'reaction'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ConvoDefsMessageInput {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.facets.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("facets")?;
...
impl ConvoDefsMessageRef {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("convoId")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.convo_id)?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text("messageId")?;
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(&self.message_id)?;
        } else {
            // Slow path: merge known fields with extra_cbor, sort, encode.
            let mut pairs: Vec<(&str, Vec<u8>)> = Vec::new();
            {
            ...
            {
                let mut vbuf = Vec::new();
                ratproto_cbor::Encoder::new(&mut vbuf).encode_text(&self.message_id)?;
    ...
    pub fn decode_cbor(
        ...
        Ok(ConvoDefsMessageRef {
            ...
            message_id: field_message_id.ok_or_else(|| {
                ratproto_cbor::CborError::InvalidCbor("missing required field 'messageId'".into())
            })?,
            extra: std::collections::HashMap::new(),
            extra_cbor,
        })
...
impl ConvoDefsMessageView {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), ratproto_cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            ratproto_cbor::Encoder::new(&mut *buf).encode_text(self.sent_at.as_str())?;
            if !self.reactions.is_empty() {
                ratproto_cbor::Encoder::new(&mut *buf).encode_text("reactions")?;
                ratproto_cbor::Encoder::new(&mut *buf)
