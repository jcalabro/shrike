...
fuzz_target!(|data: &[u8]| {
    ...
    let val2 = ratproto_cbor::decode(&encoded)
        .expect("decoding re-encoded DRISL must succeed");
    let encoded2 = ratproto_cbor::encode_value(&val2)
