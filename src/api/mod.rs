...
//! Generated types for all AT Protocol and Bluesky lexicons.
//!
//! This module contains Rust structs and enums generated from Lexicon JSON
//! schemas by the `lexgen` tool. Three namespaces are provided:
//!
//! - [`app::bsky`] — Bluesky application types (posts, feeds, actors, graphs, etc.)
//! - [`com::atproto`] — Core AT Protocol types (repos, sync, identity, labels, etc.)
//! - [`chat::bsky`] — Bluesky direct message types
//! - [`tools::ozone`] — Ozone moderation tooling types
//!
//! Each XRPC method has a corresponding function (e.g., `app::bsky::actor_get_profile`)
//! along with typed parameter and output structs. Record types include CBOR
//! encoding/decoding methods for repository storage.
