...
impl<'a> FeedLikeCborView<'a> {
    ...
    pub fn to_owned(&self) -> Result<FeedLike, crate::cbor::CborError> {
        Ok(FeedLike {
            via: self
                .via
                .as_ref()
    ...
    pub fn decode_cbor(
        ...
        Ok(Self {
            via: field_via,
            r#type: field_type.unwrap_or("app.bsky.feed.like"),
            subject: field_subject.ok_or_else(|| {
                crate::cbor::CborError::InvalidCbor("missing required field 'subject'".into())
            })?,
            created_at: field_created_at.ok_or_else(|| {
