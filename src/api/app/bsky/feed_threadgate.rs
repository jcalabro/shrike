...
#[derive(Debug)]
pub struct FeedThreadgateFollowerRuleCborView<'a> {
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> FeedThreadgateFollowerRuleCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<FeedThreadgateFollowerRule, crate::cbor::CborError> {
        Ok(FeedThreadgateFollowerRule {
            extra: std::collections::HashMap::new(),
            extra_cbor: self
                .extra_cbor
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct FeedThreadgateFollowingRuleCborView<'a> {
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> FeedThreadgateFollowingRuleCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<FeedThreadgateFollowingRule, crate::cbor::CborError> {
        Ok(FeedThreadgateFollowingRule {
            extra: std::collections::HashMap::new(),
            extra_cbor: self
                .extra_cbor
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct FeedThreadgateListRuleCborView<'a> {
    pub list: crate::syntax::AtUriRef<'a>,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> FeedThreadgateListRuleCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<FeedThreadgateListRule, crate::cbor::CborError> {
        Ok(FeedThreadgateListRule {
...
impl FeedThreadgate {
    ...
    pub fn encode_cbor(&self, buf: &mut Vec<u8>) -> Result<(), crate::cbor::CborError> {
        if self.extra_cbor.is_empty() {
            ...
            if !self.hidden_replies.is_empty() {
                crate::cbor::Encoder::new(&mut *buf).encode_text("hiddenReplies")?;
            ...
            if !self.allow.is_empty() {
                let mut vbuf = Vec::new();
                crate::cbor::Encoder::new(&mut vbuf).encode_array_header(self.allow.len() as u64)?;
                for item in &self.allow {
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct FeedThreadgateCborView<'a> {
...
impl<'a> FeedThreadgateCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<FeedThreadgate, crate::cbor::CborError> {
        Ok(FeedThreadgate {
            post: self.post.to_owned(),
            r#type: self.r#type.to_owned(),
            allow: self.allow.clone(),
            created_at: self.created_at.to_owned(),
            hidden_replies: self.hidden_replies.clone(),
            extra: std::collections::HashMap::new(),
            extra_cbor: self
                .extra_cbor
                .iter()
    ...
    pub fn decode_cbor(
        ...
        entries.try_field(b"\x65\x61\x6c\x6c\x6f\x77", |decoder| {
            let value = decoder.decode()?;
            if let crate::cbor::Value::Array(items) = value {
                for item in items {
                    let raw = crate::cbor::encode_value(&item)?;
        ...
        entries.try_field(
            b"\x6d\x68\x69\x64\x64\x65\x6e\x52\x65\x70\x6c\x69\x65\x73",
            |decoder| {
                let value = decoder.decode()?;
                if let crate::cbor::Value::Array(items) = value {
                    for item in items {
        ...
        Ok(Self {
            ...
            r#type: field_type.unwrap_or("app.bsky.feed.threadgate"),
            allow: field_allow,
            created_at: field_created_at.ok_or_else(|| {
                crate::cbor::CborError::InvalidCbor("missing required field 'createdAt'".into())
            })?,
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct FeedThreadgateMentionRuleCborView<'a> {
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> FeedThreadgateMentionRuleCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<FeedThreadgateMentionRule, crate::cbor::CborError> {
        Ok(FeedThreadgateMentionRule {
            extra: std::collections::HashMap::new(),
            extra_cbor: self
                .extra_cbor
