...
/// EmbedRecord — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
...
impl<'a> EmbedRecordCborView<'a> {
    ...
    pub fn to_owned(&self) -> Result<EmbedRecord, crate::cbor::CborError> {
        Ok(EmbedRecord {
...
/// EmbedRecordView — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct EmbedRecordViewCborView<'a> {
    pub record: EmbedRecordViewRecordUnion,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> EmbedRecordViewCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<EmbedRecordView, crate::cbor::CborError> {
        Ok(EmbedRecordView {
...
/// EmbedRecordViewBlocked — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct EmbedRecordViewBlockedCborView<'a> {
...
impl<'a> EmbedRecordViewBlockedCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<EmbedRecordViewBlocked, crate::cbor::CborError> {
        Ok(EmbedRecordViewBlocked {
...
/// EmbedRecordViewDetached — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct EmbedRecordViewDetachedCborView<'a> {
    pub uri: crate::syntax::AtUriRef<'a>,
    pub detached: bool,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> EmbedRecordViewDetachedCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<EmbedRecordViewDetached, crate::cbor::CborError> {
        Ok(EmbedRecordViewDetached {
            uri: self.uri.to_owned(),
    ...
    pub fn decode_cbor(
        ...
        entries.try_field(b"\x68\x64\x65\x74\x61\x63\x68\x65\x64", |decoder| {
            let value = decoder.decode()?;
            if let crate::cbor::Value::Bool(b) = value {
                field_detached = Some(b);
            } else {
...
/// EmbedRecordViewNotFound — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct EmbedRecordViewNotFoundCborView<'a> {
    pub uri: crate::syntax::AtUriRef<'a>,
    pub not_found: bool,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> EmbedRecordViewNotFoundCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<EmbedRecordViewNotFound, crate::cbor::CborError> {
        Ok(EmbedRecordViewNotFound {
            uri: self.uri.to_owned(),
...
/// EmbedRecordViewRecord — A representation of a record embedded in a Bluesky record (eg, a post). For example, a quote-post, or sharing a feed generator record.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// A validated CBOR view. Borrowed fields cannot outlive the input.
#[derive(Debug)]
pub struct EmbedRecordViewRecordCborView<'a> {
    pub cid: &'a str,
    pub uri: crate::syntax::AtUriRef<'a>,
    pub value: serde_json::Value,
...
impl<'a> EmbedRecordViewRecordCborView<'a> {
    #[inline]
    pub fn from_cbor(data: &'a [u8]) -> Result<Self, crate::cbor::CborError> {
        let mut decoder = crate::cbor::Decoder::new(data);
        let result = Self::decode_cbor(&mut decoder)?;
    ...
    pub fn to_owned(&self) -> Result<EmbedRecordViewRecord, crate::cbor::CborError> {
        Ok(EmbedRecordViewRecord {
    ...
    pub fn decode_cbor(
        ...
        entries.try_field(b"\x66\x65\x6d\x62\x65\x64\x73", |decoder| {
            let value = decoder.decode()?;
            if let crate::cbor::Value::Array(items) = value {
                for item in items {
                    let raw = crate::cbor::encode_value(&item)?;
                    let mut dec = crate::cbor::Decoder::new(&raw);
                    field_embeds.push(EmbedRecordViewRecordEmbedsUnion::decode_cbor(&mut dec)?);
                }
            } else {
                return Err(crate::cbor::CborError::InvalidCbor("expected array".into()));
            }
