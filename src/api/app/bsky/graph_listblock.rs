...
pub struct GraphListblock {
    ...
    #[serde(rename = "$type", default = "default_type_graphlistblock")]
    pub r#type: String,
...
fn default_type_graphlistblock() -> String {
    "app.bsky.graph.listblock".to_string()
}
...
impl GraphListblock {
    ...
    pub fn decode_cbor(decoder: &mut crate::cbor::Decoder) -> Result<Self, crate::cbor::CborError> {
        ...
        Ok(GraphListblock {
            r#type: field_type.unwrap_or_else(|| "app.bsky.graph.listblock".to_string()),
...
#[derive(Debug)]
pub struct GraphListblockCborView<'a> {
    pub r#type: &'a str,
...
impl<'a> GraphListblockCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<GraphListblock, crate::cbor::CborError> {
        Ok(GraphListblock {
    ...
    pub fn decode_cbor(
        ...
        drop(entries);
        Ok(Self {
            r#type: field_type.unwrap_or("app.bsky.graph.listblock"),
            subject: field_subject.ok_or_else(|| {
                crate::cbor::CborError::InvalidCbor("missing required field 'subject'".into())
            })?,
            created_at: field_created_at.ok_or_else(|| {
