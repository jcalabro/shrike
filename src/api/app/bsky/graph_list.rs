...
#[derive(Debug)]
pub struct GraphListCborView<'a> {
    pub name: &'a str,
    pub r#type: &'a str,
    pub avatar: Option<crate::api::Blob>,
    pub labels: Option<GraphListLabelsUnion>,
...
impl<'a> GraphListCborView<'a> {
    ...
    pub fn to_owned(&self) -> Result<GraphList, crate::cbor::CborError> {
        Ok(GraphList {
    ...
    pub fn decode_cbor(
        ...
        Ok(Self {
            ...
            r#type: field_type.unwrap_or("app.bsky.graph.list"),
            avatar: field_avatar,
            labels: field_labels,
            purpose: field_purpose.ok_or_else(|| {
                crate::cbor::CborError::InvalidCbor("missing required field 'purpose'".into())
