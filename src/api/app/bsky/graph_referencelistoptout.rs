...
#[derive(Debug)]
pub struct GraphReferencelistoptoutCborView<'a> {
    pub r#type: &'a str,
    pub subject: crate::syntax::AtUriRef<'a>,
    pub created_at: crate::syntax::DatetimeRef<'a>,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> GraphReferencelistoptoutCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<GraphReferencelistoptout, crate::cbor::CborError> {
        Ok(GraphReferencelistoptout {
    ...
    pub fn decode_cbor(
        ...
        let mut field_subject: Option<crate::syntax::AtUriRef<'a>> = None;
        ...
        drop(entries);
        Ok(Self {
            r#type: field_type.unwrap_or("app.bsky.graph.referencelistoptout"),
            subject: field_subject.ok_or_else(|| {
                crate::cbor::CborError::InvalidCbor("missing required field 'subject'".into())
            })?,
            created_at: field_created_at.ok_or_else(|| {
