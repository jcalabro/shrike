...
#[derive(Debug)]
pub struct UnspeccedGetPostThreadV2ThreadItemCborView<'a> {
...
impl<'a> UnspeccedGetPostThreadV2ThreadItemCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<UnspeccedGetPostThreadV2ThreadItem, crate::cbor::CborError> {
        Ok(UnspeccedGetPostThreadV2ThreadItem {
