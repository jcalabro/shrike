...
#[derive(Debug)]
pub struct VerificationRevokeVerificationsRevokeErrorCborView<'a> {
    pub uri: crate::syntax::AtUriRef<'a>,
    pub error: &'a str,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> VerificationRevokeVerificationsRevokeErrorCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(
        &self,
    ) -> Result<VerificationRevokeVerificationsRevokeError, crate::cbor::CborError> {
        Ok(VerificationRevokeVerificationsRevokeError {
