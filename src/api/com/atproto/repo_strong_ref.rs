...
/// RepoStrongRef — A URI with a content-hash fingerprint.
...
#[derive(Debug)]
pub struct RepoStrongRefCborView<'a> {
    pub cid: &'a str,
    pub uri: crate::syntax::AtUriRef<'a>,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> RepoStrongRefCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<RepoStrongRef, crate::cbor::CborError> {
        Ok(RepoStrongRef {
