...
#[derive(Debug)]
pub struct SyncListReposRepoCborView<'a> {
    pub did: crate::syntax::Did,
    pub rev: crate::syntax::Tid,
    pub head: &'a str,
    pub active: Option<bool>,
...
impl<'a> SyncListReposRepoCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<SyncListReposRepo, crate::cbor::CborError> {
        Ok(SyncListReposRepo {
            did: self.did.clone(),
            rev: self.rev,
    ...
    pub fn decode_cbor(
        ...
        let mut field_did: Option<crate::syntax::Did> = None;
        let mut field_rev: Option<crate::syntax::Tid> = None;
        let mut field_head: Option<&'a str> = None;
        let mut field_active: Option<bool> = None;
        ...
        entries.try_field(b"\x64\x68\x65\x61\x64", |decoder| {
            field_head = Some(decoder.text()?);
            Ok(())
        })?;
