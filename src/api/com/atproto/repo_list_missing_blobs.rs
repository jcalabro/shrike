...
#[derive(Debug)]
pub struct RepoListMissingBlobsRecordBlobCborView<'a> {
    pub cid: &'a str,
    pub record_uri: crate::syntax::AtUriRef<'a>,
    pub extra_cbor: Vec<(&'a str, &'a [u8])>,
    raw_cbor: &'a [u8],
}
impl<'a> RepoListMissingBlobsRecordBlobCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<RepoListMissingBlobsRecordBlob, crate::cbor::CborError> {
        Ok(RepoListMissingBlobsRecordBlob {
            cid: self.cid.to_owned(),
            record_uri: self.record_uri.to_owned(),
            extra: std::collections::HashMap::new(),
            extra_cbor: self
                .extra_cbor
                .iter()
