...
#[derive(Debug)]
pub struct ServerListAppPasswordsAppPasswordCborView<'a> {
    pub name: &'a str,
...
impl<'a> ServerListAppPasswordsAppPasswordCborView<'a> {
    #[inline]
    ...
    pub fn to_owned(&self) -> Result<ServerListAppPasswordsAppPassword, crate::cbor::CborError> {
        Ok(ServerListAppPasswordsAppPassword {
...
) -> Result<ServerListAppPasswordsOutput, crate::xrpc::Error> {
    client
